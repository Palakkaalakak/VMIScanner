...
with tab_scan:
    ...
    _METRIC_LABELS = {
        ...
        "intrinsic_value_conservative": "Conservative IV $ (lowest est.)",
        "intrinsic_value_doomsday": "Doomsday IV $ (half growth yrs 6-10)",
        "direct_growth_low": "Lowest provider growth %",
        "mos_verdict": "Margin-of-safety verdict",
        "peg_adam": "PEG (Adam: <=1.5 OK)",
        "peg_verdict": "PEG verdict",
        "ps_avg_5y": "5y avg P/S",
        "fair_value_ps": "Fair value P/S method $",
        "pb_avg_5y": "5y avg P/B",
        "fair_value_pb": "Fair value P/B method $",
        "rev_growth_proj": "Projected revenue growth %",
        "psg": "PSG (P/S / rev growth)",
